...
@section('content')
    ...
    <section class="my-6">
        <div class="bg-white rounded-lg shadow-md p-6">
            <img src="{{ $restaurant->image }}" id="restaurantImage" alt="{{ $restaurant->name }}" class="w-full h-48 object-cover rounded-lg">
    ...
    <section class="my-6">
        ...
        <div class="flex space-x-4 mb-4">
            ...
            <button class="menu-filter px-4 py-2 bg-gray-200 text-gray-700 rounded-full" data-category="appetizer">پیش‌غذا</button>
            <button class="menu-filter px-4 py-2 bg-gray-200 text-gray-700 rounded-full" data-category="main">غذای اصلی</button>
            <button class="menu-filter px-4 py-2 bg-gray-200 text-gray-700 rounded-full" data-category="dessert">دسر</button>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6" id="menuList">
            @foreach ($restaurant->menuItems as $item)
                <div class="menu-item bg-white rounded-lg shadow-md p-4 flex">
